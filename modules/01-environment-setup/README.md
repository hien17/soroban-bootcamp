...
```
https://friendbot-futurenet.stellar.org/?addr=YOUR_PUBLIC_KEY
```
...
### Option C: Script
```bash
curl -s "https://friendbot-futurenet.stellar.org/?addr=$(stellar keys address student)" | head -1
```
...
| **Testnet** | Pre-production | `https://soroban-testnet.stellar.org` | `https://friendbot.stellar.org` |
...
| Freighter won't connect | Make sure you're on the right network (Futurenet) |
